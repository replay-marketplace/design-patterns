...
A Python package for common file processing operations including reading, writing, and directory management.
...
**Parameters:**
- `structure` (dict): A dictionary representing the directory structure where keys are directory paths and values are nested dictionaries
