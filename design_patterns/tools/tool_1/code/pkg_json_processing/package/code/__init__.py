"""
Package JSON Processing - A Python package with JSON processing utilities.

This package provides useful JSON manipulation, validation, and directory conversion functions.
"""
