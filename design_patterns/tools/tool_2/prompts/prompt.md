...
|   │   ├── <function_1>.py         # Empty
|   │   ├── <function_2>.py         # Empty
|   ├── <package_name>_tests/   ← Dir for tests
│   │   ├── test.py
│   │   ├── setup_and_run.sh    # pip install -q -e $TOOL_2_PATH/code/<package_name>_pkg
│   │   ├── requirements.txt
│   │   └── venv/
```
...
1. `code_gen(prompt: str, project_name: str) -> dir` - Code generation, returns the dir with the code
...
count_loc = <int>
count_files = <int>
count_python_imports = <int>
count_python_functions = <int>
```

Use these available python packages:
1. String Processing:   design_patterns/tools/tool_2/code/pkg_string_processing/README_API_SIGNATURE.md
2. File Processing:     design_patterns/tools/tool_2/code/pkg_file_processing/README_API_SIGNATURE.md
3. Agent Chat:          design_patterns/tools/tool_2/code/pkg_agent_chat/README_API_SIGNATURE.md
4. Analysis:            design_patterns/tools/tool_2/code/pkg_analysis/README_API_SIGNATURE.md
4. JSON Processing:     design_patterns/tools/tool_2/code/pkg_json_processing/README_API_SIGNATURE.md
