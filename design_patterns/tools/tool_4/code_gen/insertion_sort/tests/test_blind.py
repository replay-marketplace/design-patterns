...
class TestInsertionSort(unittest.TestCase):
    """Test cases for insertion_sort function."""
    ...
    def test_negative_numbers(self):
        ...
        self.assertEqual(insertion_sort([-3, -1, -4, -1, -5]), [-5, -4, -3, -1, -1])
    
    def test_mixed_positive_negative(self):
        """Test sorting an array with mixed positive and negative numbers."""
        self.assertEqual(insertion_sort([3, -1, 4, -1, 5, -9, 2, -6]), [-9, -6, -1, -1, 2, 3, 4, 5])
